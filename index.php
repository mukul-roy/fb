...
//     array_push($likeUpdate , $likeCound);
//   }
  ...
  <div class="fb-home-body">
    ...
    <div class="fb-home-timeline-area">
      <div class="fb-home-timeline">
        ...
        //          //fileupload($_FILES['post_user_photo']);      
        //          // fileupload([
        //          //     "tmp_name" => $_FILES['post_user_photo']['tmp_name'],
        //          //     "name"     => $_FILES['post_user_photo']['name'],
        //          //   ], "media/post/user_photo/");
        ...
        //          //post videos
        //          $post_viedo = null;
        //          if ($_FILES['posta_video']['name']) {

        //            $post_viedo =  fileupload([
        //              "tmp_name"   => $_FILES['posta_video']['tmp_name'],
        //              "name"   => $_FILES['posta_video']['name'],
        //            ], 'media/post/user_photo/video/');
        //          }
        ...
        //            "post_photos"  =>  $post_photo,
        //            "post_video"  => $post_viedo,
        //            "comments"  => [],
